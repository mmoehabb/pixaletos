    ...
    <div className="w-64 flex flex-col border-l border-neutral-700 bg-neutral-800 h-full">
      ...
      <div className="flex-1 p-4 overflow-y-auto">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-xs bg-neutral-700 hover:bg-neutral-600 px-2 py-1 rounded text-white">
            +
          </button>
        </div>
      ...
      <div className="h-48 border-t border-neutral-700 p-4 bg-neutral-800/50 flex flex-col">
        ...
        <p className="text-xs text-neutral-400 mb-4">
          Select an area or layer to edit or generate content.
        </p>
        <div className="mt-auto flex border border-neutral-600 rounded overflow-hidden">
          <input
            type="text"
            placeholder="Prompt..."
            className="bg-neutral-900 text-white text-xs px-2 py-2 flex-1 outline-none"
            disabled
          />
          <button className="bg-blue-600 text-white px-3 text-xs font-medium opacity-50 cursor-not-allowed">
            Ask
          </button>
        </div>
      </div>
