      ...
      <header className="h-10 border-b border-neutral-700 bg-neutral-800 flex items-center px-4 justify-between shrink-0">
        <div className="flex items-center gap-4">
          ...
          <nav className="flex gap-1 text-sm">
            <button className="px-3 py-1 hover:bg-neutral-700 rounded text-neutral-300">File</button>
            <button className="px-3 py-1 hover:bg-neutral-700 rounded text-neutral-300">Edit</button>
            <button className="px-3 py-1 hover:bg-neutral-700 rounded text-neutral-300">Image</button>
            <button className="px-3 py-1 hover:bg-neutral-700 rounded text-neutral-300">Layer</button>
            <button className="px-3 py-1 hover:bg-neutral-700 rounded text-neutral-300">View</button>
            <button className="px-3 py-1 hover:bg-neutral-700 rounded text-blue-400">AI</button>
          </nav>
        </div>
